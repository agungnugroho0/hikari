                    ...
                    if ($dokumen):?>
                        ...
                        ?>
                            ...
                            <div class="flex gap-2 group">
                                ...
                                <a href="#"  onclick="loadPageFromMenu('router.php?page=siswa&act=hapusdoc&tipe=<?=$d['tipe']?>&file=<?=$d['dokumen']?>&id_doc=<?=$d['id_doc']?>','4')"  class="text-blue-500 dark:text-blue-400 hover:underline"><i class="fas fa-trash-alt"></i></a>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
