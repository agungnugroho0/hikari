...
<body>
<a href="/public/admin/form/tambah_job.php" class="text-white bg-gradient-to-br from-orange-600 to-red-700 hover:to-yellow-700 focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium text-sm px-5 py-2 text-center">+ Training Order</a>
              ...
              <?php foreach ($data_so['jobs'] as $job_data):?>
                <div class="grid grid-cols-2 p-2 bg-slate-50 relative min-h-20">
                  ...
                  <div class="absolute right-0 top-0 ">
                    <a href="/public/admin/form/edit_job.php?id_job=<?= $job_data['id_jobs']?>" class="block mb-4 mt-2" >
                      ...
                      <a href="/app/database/delete_job.php?id_job=<?= $job_data['id_jobs']?>" class="block">
                ...
                <?php if (!empty($job_data['peserta'])): ?>
                  <?php foreach ($job_data['peserta'] as $i => $peserta): ?>
                      <div class="flex flex-row hover:bg-slate-100  py-2">
                        ...
                        <a href="/public/admin/form/lolos_job.php?id_w=<?= $peserta['id_w']?>" class="px-2 ">
                        ...
                        <a href="/app/database/gagal_siswa.php?id_w=<?= $peserta['id_w']?>" class="px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
